...
import com.xworkz.ecom.crud.Ecom;
import com.xworkz.ecom.crud.impl.EcomImpl;
...
public class EcomTester {
	public static void main(String a[]) {
		...
		do {
			...
			case 5:
				System.out.print("Enter the existing ID for Name of the order: ");
				int existingId = sc.nextInt();
				ec.getOrderNameById(existingId);

			case 6:
				System.out.print("Enter the existing Name for Type of the order: ");
